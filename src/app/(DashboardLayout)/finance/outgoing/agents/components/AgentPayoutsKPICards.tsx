...
const AgentPayoutsKPICards: React.FC = () => {
  const kpiData = [
    {
      title: 'Total Payable',
      value: '₦18,420,000',
      subtitle: 'Amount owed to agents',
    ...
    },
    {
      ...
      value: '42',
      subtitle: 'Agents awaiting payment',
  ...
  return (
    <DashboardCard title="Payout Summary">
...
export default AgentPayoutsKPICards;
