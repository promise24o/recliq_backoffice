...
const InvoiceDetail = () => {
  ...
  const orderDate = selectedInvoice.orderDate
    ? isValid(parseISO(selectedInvoice.orderDate.toString()))
      ? format(parseISO(selectedInvoice.orderDate.toString()), "EEEE, MMMM dd, yyyy")
      : "Invalid Date"
  ...
  return (<>
    ...
    <Box display="flex" alignItems="center" gap={1} mt={3} justifyContent="end">
      ...
      <Button variant="contained" color="primary" component={Link} href="/apps/invoice/list">
